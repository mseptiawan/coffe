import { Sparkles, CheckCircle2, MessageCircle, ArrowUpRight } from "lucide-react";
            ...
            <div className="max-w-lg space-y-5">
              ...
              <div className="space-y-3">
                <h2 className="text-2xl md:text-3xl font-black leading-tight text-white">
                  Punya ide aplikasi <br />
                  <span className="bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">
                    atau website?
                  </span>
                </h2>
                <p className="text-sm leading-relaxed text-zinc-400">
                  <span className="font-bold text-zinc-200">Pemenang Karir</span> bantu bikin web custom, UMKM & dashboard profesional.
                </p>
              </div>

              {/* List Simpel */}
              <div className="grid grid-cols-2 gap-2">
                {["Landing Page", "App Custom", "Dashboard", "Maintenance"].map((item) => (
                  <div key={item} className="flex items-center gap-2 text-[11px] font-bold text-zinc-500">
